              ...
              <Card>
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Box sx={{ textAlign: 'center', p: 3, bgcolor: 'grey.100', borderRadius: 2 }}>
                    ...
                    <Typography variant="h2" sx={{ fontWeight: 700, color: registeredCredits + totalCredits > 21 ? 'error.main' : 'text.primary' }}>
                    ...
                    <LinearProgress
                      variant="determinate"
                      value={Math.min(((registeredCredits + totalCredits) / 21) * 100, 100)}
                      sx={{
                        mt: 2,
                        height: 10,
                        borderRadius: 5,
                      ...
                      color={registeredCredits + totalCredits > 21 ? 'error' : registeredCredits + totalCredits > 18 ? 'warning' : 'primary'}
                    />
                  </Box>
                  ...
                  {registeredCredits + totalCredits > 18 && registeredCredits + totalCredits <= 21 && (
