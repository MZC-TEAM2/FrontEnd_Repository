...
import {getCurrentGradePublishPeriod, getStudentGrades} from '../api/gradeApi';
        ...
        <Container maxWidth="xl" sx={{py: 3}}>
            ...
            <Paper sx={{mb: 3}}>
                ...
                >
                    ...
                    <Tab icon={<CampaignIcon/>} label="공지사항" iconPosition="start"/>
                    ...
                    <Paper sx={{p: 3, mb: 3}}>
                        <Box sx={{display: 'flex', alignItems: 'center', gap: 2, mb: 2}}>
                            <EventAvailableIcon sx={{
                                fontSize: 40,
                                color: `${attendanceService.getAttendanceColor(attendance.attendanceRate)}.main`
                            }}/>
                            <Box sx={{flex: 1}}>
                                                ...
                                                return (
                                                    <React.Fragment key={content.id}>
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            {isCompleted && (
                                                                <Chip label="출석인정" size="small" color="success"
                                                                      sx={{mr: 1}}/>
                                                            )}
                                                            <IconButton
                                                                edge="end"
