            ...
            >
                <Box>
                    <Typography variant="body2"
                                sx={{fontWeight: 600, color: courseColorById[course.id] || 'primary.main'}}>
                        {course.name}
                    </Typography>
                ...
                <TableContainer component={Paper} sx={{mb: 3}}>
                    <Table size="small" sx={{tableLayout: 'fixed'}}>
                        ...
                        <TableHead>
                            <TableRow>
                                <TableCell
                                    sx={{width: 80, backgroundColor: 'primary.light', color: 'white', fontWeight: 600}}>
                                    시간
                                </TableCell>
                            ...
                            {Array.from({length: 18}, (_, timeIndex) => {
                                ...
                                return (
                                    <TableRow key={timeIndex}>
                                        ...
                                        {weekDays.map((day) =>
                                            loading ? (
                                                <TableCell key={`${day}-${timeIndex}`}
                                                           sx={{border: '1px solid #e0e0e0', height: 40}}>
                                                    <Skeleton/>
                                                </TableCell>
                                            ) : (
                                ...
                                >
                                    ...
                                    <Box sx={{mt: 2, display: 'flex', flexDirection: 'column', gap: 0.5}}>
                                        <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
                                            ...
                                            <Typography variant="body2">{loading ?
                                                <Skeleton width={120}/> : course?.professor}</Typography>
                                        </Box>
                                        <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
                                            <LocationOnIcon fontSize="small" color="action"/>
                                            <Typography variant="body2">{loading ?
                                                <Skeleton width={140}/> : course?.classroom}</Typography>
                                        </Box>
                                        <Box sx={{display: 'flex', alignItems: 'center', gap: 1}}>
