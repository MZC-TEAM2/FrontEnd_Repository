...
const DiscussionBoardPage = () => {
  ...
  const discussionTopics = [
    { id: 'AI윤리토론', name: 'AI윤리토론', icon: '🤖', color: 'primary' },
    { id: '기후변화대응', name: '기후변화대응', icon: '🌍', color: 'success' },
    { id: '교육개혁', name: '교육개혁', icon: '📚', color: 'warning' },
    { id: '메타버스미래', name: '메타버스미래', icon: '🥽', color: 'info' },
    { id: '청년정책', name: '청년정책', icon: '🎯', color: 'secondary' },
    { id: 'ESG경영', name: 'ESG경영', icon: '🌱', color: 'success' },
    { id: '디지털전환', name: '디지털전환', icon: '💻', color: 'primary' },
    { id: '사회적가치', name: '사회적가치', icon: '❤️', color: 'error' },
  ];
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        ...
        <Button
          variant="contained"
          onClick={() => navigate('/boards/discussion/create')}
        >
          토론 시작
        </Button>
      </Box>
                ...
                filteredPosts.map((post, index) => {
                  ...
                  return (
                    <TableRow
                      key={post.id}
                      hover
                      onClick={() => handleRowClick(post.id, '/boards/discussion')}
                      sx={{ cursor: 'pointer' }}
                    >
