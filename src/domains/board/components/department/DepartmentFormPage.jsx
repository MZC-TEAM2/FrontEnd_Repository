...
const DepartmentFormPage = () => {
  ...
  const {
    ...
    categoryId: 5,
    boardName: '학과 게시판',
    createPostFn: createDepartmentPost,
    updatePostFn: updateDepartmentPost,
    loadForEditFn: loadDepartmentForEdit,
    setFormData,
    setExistingFiles,
    validateForm,
    setError,
    ...
    <Box>
      ...
      <Paper sx={{ p: 4 }}>
        <Typography variant="h5" sx={{ fontWeight: 600, mb: 3 }}>
          {isEditMode ? '학과 게시판 수정' : '학과 게시판 작성'}
        </Typography>

        {/* 게시글 타입 */}
        <PostTypeSelector boardType="DEPARTMENT" value={formData.postType} onChange={handleInputChange} />
