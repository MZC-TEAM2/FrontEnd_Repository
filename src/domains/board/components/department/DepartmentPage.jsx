...
const DepartmentPage = () => {
  ...
  // useDepartment 훅에서 공통 함수 가져오기
  const { fetchDepartmentDetail, handleBackToList } = useDepartment();
  ...
  useEffect(() => {
    const loadDetail = async () => {
      ...
      setError(null);
      try {
        const data = await fetchDepartmentDetail(id);
        setPost(data);
        ...
        console.error('학과 게시판 조회 실패:', err);
  ...
  return (
    <Box>
      ...
      <PostNavigation
        ...
        onEdit={() => navigate(`/departments/${id}/edit`)}
