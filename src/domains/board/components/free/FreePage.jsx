...
const FreePage = () => {
  ...
  // useFree 훅에서 공통 함수 가져오기
  const { fetchFreeDetail, handleBackToList } = useFree();
  ...
  useEffect(() => {
    const loadDetail = async () => {
      ...
      setError(null);
      try {
        const data = await fetchFreeDetail(id);
        setPost(data);
        ...
        console.error('자유 게시판 조회 실패:', err);
