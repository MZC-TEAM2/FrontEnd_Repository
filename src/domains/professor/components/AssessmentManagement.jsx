              ...
              <ListItem
                ...
                secondaryAction={
                  <Box sx={{ display: 'flex', gap: 1 }}>
                    ...
                    <IconButton size="small" color="error" onClick={() => handleDelete(x.id)} title="삭제">
                ...
                <ListItemText
                  primary={
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                      ...
                      <Chip size="small" label={formatTypeLabel(x.type || (isQuiz ? 'QUIZ' : 'MIDTERM'))} />
                    </Box>
                  }
                            ...
                            onChange={(e) => {
                              ...
                              setQuestions((prev) =>
                                prev.map((x, i) => {
                                  ...
                                  return { ...x, type: 'MCQ', choices: nextChoices, correctAnswerIndex: nextCorrect };
                                })
                              );
                            }}
                          >
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                                ...
                                onClick={() =>
                                  setQuestions((prev) =>
                                    prev.map((x, i) => {
                                      ...
                                      return { ...x, choices: nextChoices, correctAnswerIndex: nextCorrect };
                                    })
                                  )
                                }
                            ...
                            <TextField
                              ...
                              onChange={(e) =>
                                setQuestions((prev) =>
                                  prev.map((x, i) =>
                                    i === idx ? { ...x, correctAnswerIndex: Number(e.target.value) - 1 } : x
                                  )
                                )
                              }
                            >
