...
import {
  getProfessorExamAttemptResult,
  getProfessorExamAttempts,
  gradeExamAttempt,
      ...
      <DialogTitle>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            {isQuiz && (
              <Button size="small" variant="outlined" onClick={fetchQuizScores} disabled={quizScoreLoading || loading}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2, flexWrap: 'wrap' }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2">{detail?.submittedAt ? formatDateTimeDot(detail.submittedAt) : '-'}</Typography>
                  </Box>
                  <Box>
                    <Typography variant="subtitle2" color="text.secondary">
                        점수
                                  ...
                                  {Number.isFinite(Number(correctIdx)) && (
                                    <Typography variant="caption" color="text.secondary">
                                      ...
                                      {isCorrect == null ? null : isCorrect ? (
                                        <Chip size="small" color="success" label="정답" sx={{ ml: 1 }} />
                                      ) : (
                                        <Chip size="small" color="error" label="오답" sx={{ ml: 1 }} />
                                      )}
                                    </Typography>
                                  )}
                                  {!isQuiz && (
                            ...
                            {!isQuiz && isSubjective && (
                              <Box sx={{ mt: 1.5, display: 'flex', justifyContent: 'flex-end' }}>
                                <TextField
                                  ...
                                  onChange={(e) =>
                                    setSubjectiveScores((prev) => ({ ...prev, [qid]: e.target.value }))
                                  }
                  ...
                  <>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        <Chip size="small" label={`주관식 ${subjectiveGivenScore}/${subjectiveMaxScore}점`} />
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                        <Button variant="contained" onClick={handleSaveGrade} disabled={saveLoading}>
